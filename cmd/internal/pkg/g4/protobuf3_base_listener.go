...
func (s *BaseProtobuf3Listener) EnterFieldLabel(ctx *FieldLabelContext) {}

// ExitFieldLabel is called when production fieldLabel is exited.
func (s *BaseProtobuf3Listener) ExitFieldLabel(ctx *FieldLabelContext) {}
...
func (s *BaseProtobuf3Listener) EnterExtendDef(ctx *ExtendDefContext) {}

// ExitExtendDef is called when production extendDef is exited.
func (s *BaseProtobuf3Listener) ExitExtendDef(ctx *ExtendDefContext) {}
